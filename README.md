...
## Présentation
JAVAZIK est une application de gestion de catalogue musical et de playlists développée en Java. Elle propose une expérience utilisateur moderne "Sunset" avec une interface graphique Swing complète, respectant strictement l'architecture **MVC**.
